...
10. Open a bounded generic parameter editor with `openEditor()` or bind host automation to `setParameter()`, `setParameterEvents()`, or `setParameterCurve()`.
