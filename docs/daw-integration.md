...
- The website-playable VST3/AU/LV2 instruments are repo-local example bundles rendered by the native example renderer; LV2 worker/UI extensions, native plugin UI, advanced LV2 extension profiles, and broader brokered filesystem access are still security-sensitive native milestones.
