...
- The website-playable VST3/AU/LV2 instruments are repo-local example bundles rendered by the native example renderer; LV2 UI declaration metadata is path-free scanner data, while LV2 UI hosting, native plugin UI, advanced LV2 extension profiles, and native worker consumption of brokered file grants are still security-sensitive native milestones.
