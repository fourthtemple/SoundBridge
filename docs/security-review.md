...
| Full plugin-hosting surface | Open roadmap | Automation curve interpolation, AU/LV2 sidechain and multi-output routing, deeper VST3 bus negotiation and factory metadata, LV2 worker/UI support, plugin UI, and broader file access need feature-specific controls as they are implemented. |
