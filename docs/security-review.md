...
| Full plugin-hosting surface | Open roadmap | High-density automation lanes, AU/LV2 sidechain and multi-output routing, remaining VST3 bus edge cases, LV2 worker/UI support, plugin UI, and broader file access need feature-specific controls as they are implemented. |
