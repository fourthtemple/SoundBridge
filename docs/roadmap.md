...
- native worker IPC limits for command size, pending commands, stdout/stderr lines, diagnostics, startup, timeout, termination, live per-render deadlines, and bounded `render_timeout` diagnostics
