  ...
  "capabilities": {
    "pluginFormats": {
      ...
      "lv2": {
        ...
        "host": true,
        "exampleHost": true,
        "notes": "Basic LV2 audio/control host worker is available with bounded atom MIDI, atom time-position transport, per-audio-port bus routing, standard latency output-port reporting, and brokered portable/file-backed state delivery; LV2 UI extensions remain disabled."
      }
    },
    "security": {
