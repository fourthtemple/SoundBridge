...
- Wire preset, sample, cache, and licensing file access through the opt-in root-limited file grant foundation, native approval broker contract, and instance-scoped file grant attachments. Grant-backed worker-native state restore/save is implemented for VST3/AU/LV2; remaining file workflows should still avoid ambient filesystem access, grant only narrow user-approved paths where practical, and keep browser-supplied path grants behind development opt-in.
