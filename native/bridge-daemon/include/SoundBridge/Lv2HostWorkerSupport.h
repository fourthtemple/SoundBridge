...
constexpr std::uint32_t kUridBufSizeMaxBlockLength = 18;
constexpr std::uint32_t kUridBufSizeMinBlockLength = 19;
constexpr std::uint32_t kUridBufSizeNominalBlockLength = 20;
constexpr std::uint32_t kUridBufSizeSequenceSize = 21;
constexpr std::int32_t kMaxWorkerAtomSequenceBytes = 128 * 1024;
