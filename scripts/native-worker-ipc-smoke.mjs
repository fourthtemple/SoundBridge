...
async function exerciseDaemonFileGrantOperation(absolutePath) {
  ...
  const instanceFileGrantSupport = createDaemonInstanceFileGrants({
    fileGrantSupport: createFakeFileGrantSupport(grant),
...
function createFakeFileGrantSupport(grant) {
  return {
