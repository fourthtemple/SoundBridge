...
import {
  ...
  writeVst3MultiBusNativeWorkerIpcFixtures
} from "./native-worker-ipc-vst3-multibus-fixtures.mjs";
import {
...
try {
  ...
  const { multiBusNativeWorkerPath } = writeVst3MultiBusNativeWorkerIpcFixtures({ tempDir });
